...
Core identity information and public profile links live in `_data/profile.yml`. Project case studies live in `_projects/`.

The production URL is [alvarop100.github.io](https://alvarop100.github.io).
